...
public class Task3 {
    public static void main(String[] args) {
        ...
        Employee e = new Employee("Пащевський Павло Дмитрович", "Java-розробник", "googalltooth@gmail.com", "+380972409577", 33);
        System.out.print(e.output());
        System.out.println("Робота класу \"SameName\" з пакету \"subtask2_1\"");
        com.hillel.javapro.pavlopashchevskyi.task3.subtask2_1.SameName sn1 = new com.hillel.javapro.pavlopashchevskyi.task3.subtask2_1.SameName("subtask2_1");
        System.out.print(sn1.output());
        System.out.println("Робота класу \"SameName\" з пакету \"subtask2_2\"");
        com.hillel.javapro.pavlopashchevskyi.task3.subtask2_2.SameName sn2 = new com.hillel.javapro.pavlopashchevskyi.task3.subtask2_2.SameName("subtask2_2");
